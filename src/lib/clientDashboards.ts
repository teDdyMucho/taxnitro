...
export interface ClientDashboard {
  ...
  /**
   * The same mark on a canvas the shape of a list row, for the row's background.
   *
   * The logos are roughly square and the row is far wider than it is tall, so
   * filling the row with the logo itself crops it to a horizontal slice. These
   * are generated by scripts/make-card-backgrounds.py: the mark held at the
   * right, at the row's own proportions, fading out to the left.
   */
...
const ENTRIES: Entry[] = [
  {
    ...
    dashboard: {
      ...
      cardLogo: require('../../assets/clients/uniquely-enough-card.png'),
  ...
  },
  {
    ...
    dashboard: {
      ...
      cardLogo: require('../../assets/clients/first-step-to-greatness-card.png'),
  ...
  },
  {
    ...
    dashboard: {
      ...
      cardLogo: require('../../assets/clients/access-granted-education-card.png'),
  ...
  },
  {
    ...
    dashboard: {
      ...
      cardLogo: require('../../assets/clients/battle-protection-agency-card.png'),
  ...
  },
  {
    ...
    dashboard: {
      ...
      cardLogo: require('../../assets/clients/steer-llc-card.png'),
