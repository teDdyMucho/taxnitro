...
const FOLDER_LABELS: Record<string, string> = {
  ...
  bk_bank_statements:        'Bank Statements',
  bk_credit_card_statements: 'Credit Card Statements',
  bk_loan_statements:        'Loan Statements',
  bk_payroll_reports:        'Payroll Reports',
